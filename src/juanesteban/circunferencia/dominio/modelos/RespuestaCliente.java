...
public final class RespuestaCliente {
  ...
  private RespuestaCliente(
    ...
    if (Objects.isNull(destinatario) || Objects.isNull(tipo)) {
      throw new RespuestaInvalidaException(
          "El destinatario y el tipo de respuesta son obligatorios.");
    }
  ...
  public static RespuestaCliente desconectado(
      final Destinatario destinatario, final String mensaje) {
    return new RespuestaCliente(destinatario, TipoRespuesta.DESCONECTADO, null, mensaje);
  }

  public static RespuestaCliente calculoExitoso(
      final Destinatario destinatario, final Resultado resultado) {
